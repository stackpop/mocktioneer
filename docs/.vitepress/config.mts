...
// `withMermaid` renders ```mermaid fences; it wraps the config rather than
// replacing it, so everything below is plain VitePress site config.
      ...
      sidebar: [
        {
          ...
          items: [
            {
              text: 'What is Mocktioneer?',
              link: '/guide/what-is-mocktioneer',
            },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Edge Cookie Sync', link: '/api/sync' },
            { text: 'Pull Sync (Resolve)', link: '/api/resolve' },
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: 'Trusted Server (EC)',
              link: '/integrations/trusted-server',
            },
          ],
        },
      ],
